...
class NecCodecTests(unittest.TestCase):
    def test_decodes_station_seven_unlock(self):
        levels, durations = make_edges(0xFB80, 0x07)
        self.assertEqual(decode_nec_edges(levels, durations, len(levels)), (0xFB80, 0x07))
