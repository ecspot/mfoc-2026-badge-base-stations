...
static_assert(makeUnlockAddress(3) == 0xFB24, "station 3 address mismatch");
static_assert(makeUnlockAddress(4) == 0xFB28, "station 4 address mismatch");
static_assert(makeUnlockAddress(5) == 0xFB30, "station 5 address mismatch");
static_assert(makeUnlockAddress(6) == 0xFB40, "station 6 address mismatch");
